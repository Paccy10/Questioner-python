...
class TestUpdateMeetup:
    ...
    def test_update_meetup_succeeds(self, client, init_db, new_meetup, admin_auth_header):
        new_meetup.save()
        ...
        assert response.json['message'] == 'Meetup successfully updated'
        assert 'meetup' in response.json['data']
        assert response.json['data']['meetup']['topic'] == VALID_MEETUP['topic']

    def test_update_meetup_without_auth_token_fails(self, client, init_db, new_meetup):
        new_meetup.save()
        meetup_data = json.dumps(VALID_MEETUP)
        response = client.put(
    ...
    def test_update_meetup_with_invalid_auth_token_fails(self, client, init_db, new_meetup):
        new_meetup.save()
        meetup_data = json.dumps(VALID_MEETUP)
        headers = {
    ...
    def test_update_meetup_with_a_non_admin_user_fails(self,
                                                       client,
                                                       init_db,
                                                       new_meetup,
                                                       user_auth_header):
    ...
    def test_update_meetup_without_topic_fails(self,
                                               client,
                                               init_db,
                                               new_meetup,
                                               admin_auth_header):
    ...
    def test_update_meetup_without_location_fails(self,
                                                  client,
                                                  init_db,
                                                  new_meetup,
                                                  admin_auth_header):
    ...
    def test_update_meetup_without_date_fails(self, client, init_db, new_meetup, admin_auth_header):
        new_meetup.save()
    ...
    def test_update_meetup_with_invalid_date_format_fails(self,
                                                          client,
                                                          init_db,
                                                          new_meetup,
                                                          admin_auth_header):
    ...
    def test_update_meetup_with_invalid_date_fails(self,
                                                   client,
                                                   init_db,
                                                   new_meetup,
                                                   admin_auth_header):
    ...
    def test_update_meetup_with_invalid_meetup_id_fails(self,
                                                        client,
                                                        init_db,
                                                        admin_auth_header):
        meetup_data = json.dumps(INVALID_MEETUP_WITH_INVALID_DATE)
